...
\begin{itemize}%
\item[EN] Change \programUrl{while_03} by converting the \pythonilIdx{while} loop into a \pythonilIdx{for} loop.
\item[DE] Ändern Sie \programUrl{while_03}, in dem Sie die \pythonilIdx{while}-Schleife in eine \pythonilIdx{for}-Schleife umwandeln.
\end{itemize}%
\end{question}%
%
\begin{question}{Programming / Programmieren}%
...
\begin{itemize}%
\item[EN] Change \programUrl{while_03} by converting the \pythonilIdx{while} loop into a \pythonilIdx{for} loop using \pythonilIdx{enumerate}.%
\item[DE] Ändern Sie \programUrl{while_03}, in dem Sie die \pythonilIdx{while}-Schleife in eine \pythonilIdx{for}-Schleife, die \pythonilIdx{enumerate} benutzt, umwandeln.
\end{itemize}%
\end{question}%
%
\begin{question}{Programming / Programmieren}%
