...
%
\begin{itemize}%
\item[EN] Explain the output of program \programUrl{float_01} in \cref{exec:float_01}.%
\item[DE] Erklären Sie die Ausgabe des Programms \programUrl{float_01} in \cref{exec:float_01}.%
\end{itemize}%
\end{question}%
%
%
